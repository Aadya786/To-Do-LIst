...
* `index.html` - Handles the structure of the app (uses Font Awesome for the icons).
* `style.css` - Custom styles and layout to keep everything looking neat.
* `script.js` - Handles adding, checking off, and deleting the tasks.

---

## How to Run This Locally

Getting this app up and running on your computer is super easy.

1. **Clone the repo:**
   ```bash
   git clone [https://github.com/Aadya786/To-Do-LIst.git](https://github.com/Aadya786/To-Do-LIst.git)
